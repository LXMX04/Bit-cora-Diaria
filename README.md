...
- **Hoy**: hábitos diarios (ejercicio, leer, test autoescuela, lavarse los dientes), tareas semanales (ver a los abuelos) y reflexión del día.
- **Comidas**: desayuno, comida y cena, con hora y descripción.
- **Consumo**: cigarros y joints del día, con media mensual y comparación con el mes anterior.
- **Stats**: progreso mensual de hábitos, tareas semanales, gráfica de consumo y comparativa mes a mes.
- **Ajustes**: recordatorio diario mediante notificaciones y copia de seguridad (exportar/importar datos en JSON).
